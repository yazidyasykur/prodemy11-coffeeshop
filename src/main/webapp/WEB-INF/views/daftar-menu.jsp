            ...
            <div class="py-6 px-6 lg:px-8 overflow-hidden">
                ...
                <form id="formMenu" method="post" action="${contextName}/mns" class="space-y-6">
                    ...
                    <input id="formMenu" type="hidden" name="mode" value="tambah">
                      ...
                      <input id="menuId" name="menuId"  value="" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Nama Menu">
                      </div>
                      <div class="mr-6 mb-2 mt-1 ">
                      <label name="menuNama" class="mr-4">Nama menu </label>
                      <input id="menuNama" name="menuNama" value="" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Nama Menu">
                      </div>
                     <div class="mr-6 mb-2 mt-1 ">
                     <label name="menuTipe" class="mr-6">Jenis menu </label>
                      <input id="menuTipe" name="menuTipe" value="" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Makanan / Minuman">
                      </div>
                   <div class="mr-6 mb-2 mt-1 ">
                   <label name="menuGambar" class="mr-12">Gambar</label>
                      <input id="menuGambar" name="menuGambar" value="" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Gambar">
                      </div>
                 <div class="mr-6 mb-5 mt-1 ">
                 	<label name="menuDeskripsi" class="mr-10">Deskripsi </label>
                      <input id="menuDeskripsi" name="menuDeskripsi"  value="" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Komposisi">
                      </div>
                   <div class="mr-6 mb-5 mt-1 ">
                 	<label name="menuHarga" class="mr-10">Harga menu </label>
                      <input id="menuHarga" name="menuHarga"  value="" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Komposisi">
                      </div>
