            ...
            <div class="relative flex gap-2 rounded pr-2 shadow-md shadow-slate-600 outline outline-1">
              ...
              <div class="flex max-h-36 flex-col py-2">
                ...
                <div class="lg:text-md absolute right-3 bottom-3 flex w-fit gap-3 justify-self-end rounded outline outline-1">
                  <svg id="2bc" onclick="add(event);" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m6-6H6" />
                  </svg>
                  <span id="2bc">0</span>
                  <svg id="2bc" onclick="sub(event);" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
