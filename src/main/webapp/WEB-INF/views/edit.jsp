...
<body>
    <div class="d-flex" id="wrapper">
              ...
              <c:forEach items="${allMenu}" var="menu">
                <div class="g-4 my-2">                  
                    <div class="">
						...
						<button type="submit">
							<svg style="width:18px; transform:translateY(1);" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z"/></svg>
     ...
     <div id="authentication-modal" tabindex="-1" aria-hidden="true"  class="overflow-y-auto overflow-x-hidden absolute lg:left-56 top-0 z-50 w-2/3  md:h-full">
            ...
            <div class="py-6 px-6 lg:px-8 overflow-hidden">
                ...
                <form id="formMenu" method="post" action="${contextName}/mns" class="space-y-6">
                    ...
                    <input id="formMenu" type="hidden" name="mode" value="edit">
                      <div class="mr-6 mb-2 mt-1 ">
                      <input id="menuId" name="menuId" type="hidden" value="${mns.menuId}" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Nama Menu">
                      </div>
                      <div class="mr-6 mb-2 mt-1 ">
                      <label name="menuNama" class="mr-4">Nama menu </label>
                      <input id="menuNama" name="menuNama" value="${mns.menuNama}" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Nama Menu">
                      </div>
                     <div class="mr-6 mb-2 mt-1 ">
                     <label name="menuTipe" class="mr-6">Jenis menu </label>
                      <input id="menuTipe" name="menuTipe" value="${mns.menuTipe}" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Makanan / Minuman">
                      </div>
                   <div class="mr-6 mb-2 mt-1 ">
                   <label name="menuGambar" class="mr-12">Gambar</label>
                      <input id="menuGambar" name="menuGambar" value="${mns.menuGambar}" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Gambar">
                      </div>
                 <div class="mr-6 mb-2 mt-1 ">
                 	<label name="menuDeskripsi" class="mr-10">Deskripsi </label>
                      <input id="menuDeskripsi" name="menuDeskripsi"  value="${mns.menuDeskripsi}" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Komposisi">
                      </div>
                   <div class="mr-6 mb-5 mt-1 ">
                 	<label name="menuHarga" class="mr-4">Harga menu </label>
                      <input id="menuHarga" name="menuHarga"  value="${mns.menuHarga}" type="text" class="border border-black p-2 text-sm w-9/12 rounded-lg" placeholder="Komposisi">
                      </div>
